...
DEFAULT_SECRET_KEY="abc123e3h535a6482ydjjkh"
...
def generate_jwt(payload, lifetime=None):
    ...
    return jwt.encode(payload, os.environ.get('SECRET_KEY', DEFAULT_SECRET_KEY), algorithm="HS256")
...
def decode_jwt(token):
    ...
    return jwt.decode(token, os.environ.get('SECRET_KEY', DEFAULT_SECRET_KEY), algorithms=["HS256"])